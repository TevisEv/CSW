...
def generar_vista_listar(fields, table_name):
    ...
    # Make sure pluralizar is corrected to handle your specific pluralization rules correctly.
...
def generar_y_guardar_vistas(table_name, fields):
    ...
    # Assuming you update generar_vista_registrar to accept table_name
